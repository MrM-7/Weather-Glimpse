        ...
        useEffect(() => {
            if(weathermood){
                switch(weathermood){
                    ...
                    case "Haze": setWeatherState("wi-day-haze"); break;

                    case "Clear": setWeatherState("wi-day-sunny"); break;

                    case "Rain": setWeatherState("wi-day-rain"); break;

                    case "Mist": setWeatherState("wi-day-fog"); break;

                    case "Snow": setWeatherState("wi-day-snow"); break;
